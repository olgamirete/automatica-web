...
const Showcase: React.FC = () => {
  ...
  const ShowcaseContents = [
    { icon: <IconBrainChip style={iconStyles} />, text: lang.showcase_1 },
    { icon: <IconDashboard style={iconStyles} />, text: lang.showcase_2 },
    { icon: <IconCertificate style={iconStyles} />, text: lang.showcase_3 },
    { icon: <IconRobot style={iconStyles} />, text: lang.showcase_4 },
    { icon: <IconLightning style={iconStyles} />, text: lang.showcase_5 },
  ];
