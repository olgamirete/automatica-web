    ...
    return (
        <InfoCard variant="dark" bgOpacity={6} className="border border-muted" >
            ...
            <Row xs={1} sm={2} className="d-flex justify-content-center">
                <MemberCard picSrc={picFederico} name="Federico" subtitle="Project leader" urlLinkedIn="https://www.linkedin.com/in/fgiancarelli/" urlGitHub="https://github.com/omirete/" />
