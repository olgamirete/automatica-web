  ...
  elements: {
    home_text: (
      <p className="text-light lead text-center">
        Es gibt eine <span className="text-warning fw-bold">einfachere</span>{" "}
        Art die Sachen zu machen, die Ihnen viel Zeit nehmen, und bei{" "}
    ...
    it_looks_like_this_page_does_not_exist: (
      <>
        Diese Seite scheint nicht zu exisieren. Machen Sie keine Sorge! Sie
        können wieder zum{" "}
        <Link to="/" className="fw-bold link-warning">
          Anfang
        </Link>{" "}
        gehen, um zu schauen ob Sie dort das finden, was Sie gesucht hatten. Sie
        können auch uns direkt eine Nachricht schicken durch den Formular auf
        der{" "}
