...
const de = {
  ...
  home_text: (
    <p className="text-light lead text-center">
      Es gibt eine <span className="text-warning fw-bold">einfachere</span> Art die Sachen zu machen, die Ihnen viel Zeit nehmen, und bei <span className="text-info fw-bold">Automatica</span> werden wir Ihnen helfen, diese zu finden.
    </p>
  ),
  ...
  about_text: (
    <p className="lead text-center">
      Unser <span className="text-warning fw-bold">Ziel</span> ist es, Unternehmen dabei helfen, <span className="text-info fw-bold">ihre Arbeit zu automatisieren</span>, damit sie keine Zeit bei unproduktive Tätigkeiten verlieren müssen.
    </p>
  ),
  ...
  message_sent_success: 'Ihre Nachricht wurde geschickt! Wir werden Ihnen automatisch eine Bestätigungsemail schicken.',
  message_sent_error: 'Es ist ein Fehler beim Senden aufgetaucht. Bitte versuchen Sie es später erneut, oder verwenden sie eine unseren anderen Kanälen.',
  it_looks_like_this_page_does_not_exist: <>Diese Seite scheint nicht zu exisieren. Machen Sie keine Sorge! Sie können wieder zum <Link to="/" className="fw-bold">Anfang</Link> gehen, um zu schauen ob Sie dort das finden, was Sie gesucht hatten. Sie können auch uns direkt eine Nachricht schicken durch den Formular auf der <Link to="/contact" className="fw-bold">Kontakt</Link> Seite, damit wir Ihnen helfen können.</>
}
