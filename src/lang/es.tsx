...
const es: Record<string, string | ReactElement> = {
  _code: 'es',
  _name: 'Español',
  ...
  home_text: (
    <p className="text-light lead text-center">
      Hay una manera{' '}
      <span className="text-warning fw-bold">más simple</span> de hacer
      las cosas que te llevan tiempo, y en{' '}
  ...
  about_text: (
    <p className="lead text-center">
      Nuestro <span className="text-warning fw-bold">objetivo</span> es
      ayudar a las empresas a{' '}
      <span className="text-info fw-bold">automatizar su trabajo</span>
  ...
  showcase_3: (
    <>
      ...
      PowerBI, Tableau, QlikView, QuickSight, Excel, Google Sheets y mucho más.
    </>
  ),
  showcase_4: (
    <>
  ...
  showcase_5: (
    <>
      <span className="text-secondary fw-bold">Automatización</span> de
      tareas como: extracción de datos, generación de documentos, actualización
