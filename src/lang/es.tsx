...
const es: Record<string, string | ReactElement> = {
  ...
  home_text: (
    <p className="text-light lead text-center">
      Hay una manera <span className="text-warning fw-bold">más simple</span> de
      hacer las cosas que te llevan tiempo, y en{" "}
      <span className="text-info fw-bold">Automatica</span> te vamos a ayudar a
      encontrarla.
    </p>
  ),
  see_how: "¡Mira cómo!",
  ...
  about_text: (
    <p className="lead text-center">
      Nuestro <span className="text-warning fw-bold">objetivo</span> es ayudar a
      las empresas a{" "}
  ...
  showcase_4: (
    <>
      ...
      <span className="text-warning fw-bold">Machine Learning</span>, para sacar
      el mayor potencial de tus datos.
    </>
  ),
  showcase_5: (
    <>
